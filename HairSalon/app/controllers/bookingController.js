'use strict';
angular.module('booking', ['ui.bootstrap', 'ngMessages',]);

angular.module('booking').directive('booking', [function () {
    return {
        restrict: 'E',
        scope: {
            datepickerOptions: '='
...
angular.module('booking').controller('bookingController', ['$scope', '$filter', 'bookingAPIFactory', 'bookingConfig', 'authService', '$location', '$timeout', function bookingController($scope, $filter, bookingAPIFactory, bookingConfig, authService, $location, $timeout) {
    var vm = this;
...
angular.module("booking").run(["$templateCache", function ($templateCache) {
